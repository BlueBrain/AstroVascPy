...
We would love for you to contribute to the AstroVascPy project and help make it better than it is today.
...
[github]: https://github.com/BlueBrain/AstroVascPy

# Development Environment

Please make sure to install a recent version of Python (>=3.7) and the project requirements,
see the [dependencies](./setup.py#dependencies).

## Setup

It is recommended to use `conda` to develop in a sandbox environment and have mpi4py and petsc4py working properly:
cf. the `setup.sh` file for more details.
